...
static void extractGeometryTypeDetails( const std::string &geomType, std::string &flatGeomType, bool &hasZ, bool &hasM )
{
  std::map<std::string, GeometryTypeDetails> d =
  {
    ...
    { "MULTILINESTRING",   { "LINESTRING", false, false } },
    { "MULTILINESTRINGZ",  { "LINESTRING", true,  false } },
    { "MULTILINESTRINGM",  { "LINESTRING", false, true  } },
    { "MULTILINESTRINGZM", { "LINESTRING", true,  true  } },
