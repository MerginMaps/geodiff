...
# a library named Postgres::Postgres is created
# and following variables are set:
#    POSTGRES_INCLUDE_DIR
#    POSTGRES_LIBRARY

# Try using vcpkg-provided package
FIND_PACKAGE(PostgreSQL)
IF(PostgreSQL_FOUND)

  SET(POSTGRES_FOUND TRUE)
  ADD_LIBRARY(Postgres::Postgres ALIAS PostgreSQL::PostgreSQL)
  GET_TARGET_PROPERTY(POSTGRES_INCLUDE_DIR
    PostgreSQL::PostgreSQL INTERFACE_INCLUDE_DIRECTORIES)
  GET_TARGET_PROPERTY(POSTGRES_LIBRARY
    PostgreSQL::PostgreSQL LOCATION)

# or look for libpq ourselves
ELSE(PostgreSQL_FOUND)
  ...
  ELSE(WIN32)
    IF(UNIX)
      ...
      IF(POSTGRES_CONFIG)
        ...
        ELSE(CYGWIN)
          FIND_LIBRARY(POSTGRES_LIBRARY NAMES pq libpq libpqdll PATHS ${PG_TMP})
        ENDIF(APPLE)
  ...
  IF(POSTGRES_FOUND)
    ...
    ADD_LIBRARY(Postgres::Postgres UNKNOWN IMPORTED)
    SET_TARGET_PROPERTIES(Postgres::Postgres PROPERTIES
      IMPORTED_LOCATION             "${POSTGRES_LIBRARY}"
      INTERFACE_INCLUDE_DIRECTORIES "${POSTGRES_INCLUDE_DIR}")
  ELSE(POSTGRES_FOUND)
